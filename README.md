...
Block annoying web elements such as [sticky headers](https://alisdair.mcdiarmid.org/kill-sticky-headers/), [dickbars](https://daringfireball.net/2017/06/medium_dickbars), floating headers, scrolling headers, scrolling videos
stickynavs, social share bars, smartphone app banners, app download nag screens,
